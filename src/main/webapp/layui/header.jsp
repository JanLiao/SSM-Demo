<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<!-- <link rel="stylesheet" type="text/css" href="/BloodSystem/layui/css/modules/laydate/default/laydate.css" /> -->
	...
	<link id="layuicss-layer" rel="stylesheet" href="<%=request.getContextPath()%>/layui/css/modules/layer/default/layer.css?v=3.1.1" media="all">
